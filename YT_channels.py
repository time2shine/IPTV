...
channel_metadata = {
    ...
    'UCmst562fALOY2cKb4IFgqEg': {  # Tom and jerry from Boomerang UK
        'group_title': 'Kids',
        'channel_name': '0. Tom and Jerry YT',
        'channel_logo': 'https://static.wikia.nocookie.net/logopedia/images/7/7e/Tom_and_Jerry_85th_anniversary.png',
    },
}
